    ...
    for (int i = numCameras_-1 ; i >=0 ; i--) {
        ...
        try {
            ...
            if (!soft) {
                ...
                if (cams[i].is_master()) { 
                    if (MAX_RATE_SAVE_){
                      ROS_WARN("MSG:  Master first IF, max_rate_save set to TRUE"); // --dagr
                      // cams[i].setEnumValue("LineSelector", "Line2");  // --dagr, original
                      cams[i].setEnumValue("LineSelector", "Line1");  // --dagr
                      ...
                      ROS_WARN("MSG:  Master second IF, max_rate_save set to FALSE");
                      cams[i].setEnumValue("TriggerMode", "On");   // --dagr, original
                      // cams[i].setEnumValue("TriggerMode", "Off");  // --dagr
                      // cams[i].setEnumValue("LineSelector", "Line2"); // --dagr, original
                      cams[i].setEnumValue("LineSelector", "Line1");  // --dagr
                      cams[i].setEnumValue("LineMode", "Output");
                    ...
                    // cams[i].setEnumValue("LineSelector", "Line3");     // --dagr
                    // cams[i].setEnumValue("TriggerSource", "Line3");    // --dagr
                    cams[i].setEnumValue("LineSelector", "Line2");
                    cams[i].setEnumValue("TriggerSource", "Line2");
